...
$ns queue-limit $sLeaf(0) $sSpine(0) 1600
$ns ecn-threshold $sLeaf(0) $sSpine(0) [expr int( 1600 *$ecnThresholdPortion)]

$ns simplex-link $sSpine(0) $sLeaf(0) 10G 0.00002s $queueManage
$ns queue-limit $sSpine(0) $sLeaf(0) 1600
$ns ecn-threshold $sSpine(0) $sLeaf(0) [expr int( 1600 *$ecnThresholdPortion)]
...
# 1 -> 0
$ns simplex-link $sLeaf(1) $sSpine(0) 15G 0.00002s $queueManage	
$ns queue-limit $sLeaf(1) $sSpine(0) 1600
$ns ecn-threshold $sLeaf(1) $sSpine(0) [expr int( 1600 *$ecnThresholdPortion)]
$ns simplex-link $sSpine(0) $sLeaf(1) 15G 0.00002s $queueManage
$ns queue-limit $sSpine(0) $sLeaf(1) 1600
$ns ecn-threshold $sSpine(0) $sLeaf(1) [expr int( 1600 *$ecnThresholdPortion)]
...
Agent/TCP set max_ssthresh_ 500
