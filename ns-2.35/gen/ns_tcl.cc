...
\n\
Node instproc init-routes-forExplicitRoute {number} {\n\
$self instvar routes_\n\
\n\
...
nodetype_ multiPath_ ns_ rtnotif_ ptnotif_ mtRouting_ fLayer_ sLeaf_Conga_ randSalt_ loadBalancePerPacket_ loadBalanceFlowlet_\n\
\n\
...
$self instvar multiPath_ routes_ rtObject_ fLayer_ sLeaf_Conga_ randSalt_ loadBalancePerPacket_ loadBalanceFlowlet_\n\
...
\n\
\n\
Node instproc set-host {min_host max_host} {\n\
$self instvar classifier_\n\
if {[$classifier_ info class]==\"Classifier/Hash/Dest\"} {\n\
$classifier_ set-host $min_host $max_host\n\
}\n\
}\n\
\n\
Node instproc set-leaf-number {leaf_number} {\n\
$self instvar classifier_\n\
if {[$classifier_ info class]==\"Classifier/Hash/Dest\"} {\n\
$classifier_ set-leaf-number $leaf_number\n\
}\n\
}\n\
\n\
Node instproc set-port-number {port_number} {\n\
$self instvar classifier_\n\
if {[$classifier_ info class]==\"Classifier/Hash/Dest\"} {\n\
$classifier_ set-port-number $port_number\n\
}\n\
}\n\
\n\
\n\
Node instproc clb-tunnel {BlockSize_N BlockSize_P} {\n\
$self instvar classifier_\n\
if {[$classifier_ info class]==\"Classifier/Hash/Dest\"} {\n\
$classifier_ clb-tunnel $BlockSize_N $BlockSize_P\n\
}\n\
}\n\
\n\
Node instproc set-bandwidth {bandwidth} {\n\
$self instvar classifier_\n\
if {[$classifier_ info class]==\"Classifier/Hash/Dest\"} {\n\
$classifier_ set-bandwidth $bandwidth\n\
}\n\
}\n\
\n\
\n\
...
$self instvar classifier_ multiPath_ routes_ mpathClsfr_ fLayer_ sLeaf_Conga_ randSalt_ loadBalancePerPacket_ loadBalanceFlowlet_\n\
\n\
if !$multiPath_ {\n\
if {[llength $ifs] > 1} {\n\
...
\n\
$classifier_ instvar sLeaf_Conga_ nodeID_\n\
set sLeaf_Conga_ [$self set sLeaf_Conga_]\n\
set nodeID_ [$self set address_]\n\
}\n\
\n\
...
\n\
$q instvar srcID dstID packetDropped_\n\
set srcID [$src id]\n\
set dstID [$dst id]\n\
\n\
$link_ instvar fromNodeID_ toNodeID_\n\
set fromNodeID_ [$src id]\n\
set toNodeID_ [$dst id]\n\
\n\
...
\n\
if 0 {\n\
Agent/TCPSink instproc init {} {\n\
eval $self next\n\
\n\
$self instvar tunnel_agent_\n\
set tunnel_agent_ \"\"\n\
}\n\
\n\
Agent/TCP instproc tunnel { agent } {\n\
puts \"Tunnel created!\"\n\
$self set tunnel_agent_ [new Agent/CLBTunnel] \n\
$agent set tunnel_agent_ [new Agent/CLBTunnel] \n\
}\n\
}\n\
\n\
\n\
...
$self instvar staticRoute_\n\
if { [info exists staticRoute_] && [$self set staticRoute_] == 1 } {\n\
puts \"Using Static Route. Don't compute routes!\"\n\
return\n\
} \n\
if [Simulator hier-addr?] {\n\
...
\n\
Queue set packetDropped_ 0\n\
Queue set parityDropped_ 0\n\
\n\
...
Queue/FQ set srcID -1\n\
Queue/FQ set dstID -1\n\
\n\
...
\n\
Queue/DropTail set srcID -1\n\
Queue/DropTail set dstID -1\n\
Queue/DropTail set ecn_threshold_ 0\n\
\n\
Queue/CQRR set srcID -1\n\
Queue/CQRR set dstID -1\n\
Queue/CQRR set portnumber_ 1\n\
Queue/CQRR set drop_rand_ false\n\
Queue/CQRR set drop_front_ false\n\
Queue/CQRR set drop_tail_ true\n\
\n\
Queue/HCF set srcID -1\n\
Queue/HCF set dstID -1\n\
Queue/HCF set hash_bin_ 20\n\
Queue/HCF set credits_ 1\n\
\n\
...
\n\
\n\
ErrorModel set packetDropped_ 0\n\
ErrorModel set parityDropped_ 0\n\
\n\
...
\n\
Application/Traffic/LogNormal set burst_time_ .5ms\n\
Application/Traffic/LogNormal set burst_time_std_ .5ms\n\
Application/Traffic/LogNormal set idle_time_ 5ms\n\
Application/Traffic/LogNormal set idle_time_std_ 5ms\n\
Application/Traffic/LogNormal set rate_ 10Mb\n\
Application/Traffic/LogNormal set packetSize_ 210\n\
Application/Traffic/LogNormal set avg_ .5\n\
Application/Traffic/LogNormal set std_ .5\n\
\n\
\n\
...
\n\
Application/FTPSink set fct_ 0;  #CG add\n\
Application/FTPSink set flowSize_ 0;\n\
Application/FTPSink set receivedBytes_ 0;\n\
Application/FTPSink set flowStartTime_ -1; \n\
Application/FTPSink set flowStopTime_ -1;\n\
Application/FTPSink set flow_ID_ -1;\n\
Application/FTPSink set flow_num_ 0;\n\
Application/FTPSink set avg_fct_ 0;\n\
Application/FTPSink set avg_throughput_ 0;\n\
\n\
...
Classifier/Hash/Dest set maxHost_ -1\n\
\n\
Classifier/Hash/Dest set CLB_Node_ 0\n\
Classifier/Hash/Dest set BlockSize_N 0\n\
Classifier/Hash/Dest set BlockSize_P 0\n\
\n\
...
\n\
Simulator set randSeed_ 1\n\
Simulator set staticRoute_ 0\n\
Simulator set clbMaxEncoderBufferSize 0\n\
Simulator set clbParityNumber 0\n\
Simulator set clbDecodeTimes 0\n\
Simulator set clbDecodeTimeoutTimes 0\n\
Simulator set clbParityDueToFullNumber 0\n\
Simulator set congaFlowletNumber 0\n\
\n\
...
\n\
Agent/MPTCP set use_olia_ 0 ; #CG add\n\
\n\
Agent/TCP set IF_PRINT_SEQTIMELINE 0 ;	#CG add\n\
Agent/TCP set retransTimes 0 ;	#CG add\n\
Agent/TCP set timeOutTimes 0 ;	#CG add\n\
Agent/TCP set parityRetransTimes 0 ;	#CG add\n\
Agent/TCP set recoveryPacketsGenerated_ 0 ;	#CG add\n\
\n\
...
\n\
\n\
Agent/TCPSink set IF_PRINT_SEQTIMELINE 0 ;	# CG add\n\
...
\n\
Agent/TCPSink set end2end_delay_ 0;#CG add\n\
\n\
...
Agent/TCP/FullTcp set nodelay_ true; # Nagle disable\n\
...
Agent/TCP/FullTcp set interval_ 0 ; # delayed ACK interval 100ms original:0.1\n\
...
\n\
$self instvar randSeed_ staticRoute_\n\
\n\
set slinks_(0:0) 0\n\
set nconn_ 0\n\
set conn_ \"\"\n\
...
if {[[$link_([$n1 id]:[$n2 id]) queue] info class] == \"Queue/CQRR\"     } {\n\
[$link_([$n1 id]:[$n2 id]) queue] queue-limit $limit\n\
}\n\
if {[[$link_([$n1 id]:[$n2 id]) queue] info class] == \"Queue/MYFQ\"     } {\n\
[$link_([$n1 id]:[$n2 id]) queue] queue-limit $limit\n\
}\n\
if {[[$link_([$n1 id]:[$n2 id]) queue] info class] == \"Queue/HCF\"     } {\n\
[$link_([$n1 id]:[$n2 id]) queue] queue-limit $limit\n\
}\n\
}\n\
\n\
Simulator instproc port-number { n1 n2 portnumber } {\n\
$self instvar link_\n\
if {[[$link_([$n1 id]:[$n2 id]) queue] info class] == \"Queue/CQRR\" || [[$link_([$n1 id]:[$n2 id]) queue] info class] == \"Queue/DropTail\"} {\n\
[$link_([$n1 id]:[$n2 id]) queue] port-number $portnumber\n\
}\n\
}\n\
\n\
\n\
Simulator instproc set-host { n1 min_host max_host } {\n\
$n1 set-host $min_host $max_host\n\
}\n\
\n\
Simulator instproc ecn-threshold { n1 n2 ecn_threshold } {\n\
$self instvar link_\n\
if {[[$link_([$n1 id]:[$n2 id]) queue] info class] == \"Queue/DropTail\"} {\n\
[$link_([$n1 id]:[$n2 id]) queue] ecn-threshold $ecn_threshold\n\
}\n\
}\n\
\n\
Simulator instproc flow-number { n1 n2 flownumber } {\n\
$self instvar link_\n\
if {[[$link_([$n1 id]:[$n2 id]) queue] info class] == \"Queue/MYFQ\" } {\n\
[$link_([$n1 id]:[$n2 id]) queue] flow-number $flownumber\n\
}\n\
}\n\
\n\
\n\
...
puts \"[[Simulator instance] now]---Node([$self set nodeID_]):\\t[array size slots_] slots\"\n\
...
set link [$self link $from $to]\n\
\n\
$lossobj instvar packetDropped_ \n\
\n\
...
\n\
\n\
Simulator instproc addExplicitRoute {node dst via } {\n\
set link2via [$self link $node $via]\n\
if {$link2via != -1 && $link2via != \"\"} {\n\
$node add-routes [$dst node-addr] $link2via\n\
} else {\n\
puts \"Warning: No link exists between node [$node node-addr] and [$via node-addr]. Explicit route not\n\
added.\"\n\
}\n\
}\n\
\n\
Simulator instproc finished-flow-add {} {\n\
$self instvar finished_flow flowNumber_\n\
if {![info exists flowNumber_]} {\n\
puts \"Warning: No flowNumber bind to the Simulator!!\"\n\
$self set flowNumber_ -1\n\
}\n\
\n\
if {![info exists finished_flow]} {\n\
set finished_flow 1\n\
} else {\n\
set finished_flow [expr $finished_flow+1]\n\
}\n\
\n\
puts stderr \"flowNumber=$flowNumber_, finished $finished_flow\"\n\
\n\
if {$flowNumber_ == -1} {\n\
return\n\
}\n\
\n\
if { $finished_flow >= $flowNumber_} {\n\
$self at [expr [$self now]+2] \"finish\" \n\
}\n\
}\n\
\n\
Simulator instproc conga-flowlet-add {} {\n\
$self instvar congaFlowletNumber\n\
\n\
if {![info exists congaFlowletNumber]} {\n\
set congaFlowletNumber 1\n\
} else {\n\
set congaFlowletNumber [expr $congaFlowletNumber+1]\n\
}\n\
}\n\
\n\
Simulator instproc clb-max-encode-buffer-size { size } {\n\
$self instvar clbMaxEncoderBufferSize\n\
\n\
if {![info exists clbMaxEncoderBufferSize]} {\n\
set clbMaxEncoderBufferSize $size\n\
} else {\n\
if {$size>$clbMaxEncoderBufferSize} {\n\
set clbMaxEncoderBufferSize $size\n\
}\n\
}\n\
}\n\
\n\
Simulator instproc clb-parity-number-add { } {\n\
$self instvar clbParityNumber\n\
if {![info exists clbParityNumber]} {\n\
set clbParityNumber 1\n\
} else {\n\
set clbParityNumber [expr $clbParityNumber+1]\n\
}\n\
}\n\
\n\
Simulator instproc clb-decode-times-add { } {\n\
$self instvar clbDecodeTimes\n\
if {![info exists clbDecodeTimes]} {\n\
set clbDecodeTimes 1\n\
} else {\n\
set clbDecodeTimes [expr $clbDecodeTimes+1]\n\
}\n\
}\n\
\n\
Simulator instproc clb-decode-timeout-add { } {\n\
$self instvar clbDecodeTimeoutTimes\n\
if {![info exists clbDecodeTimeoutTimes]} {\n\
set clbDecodeTimeoutTimes 1\n\
} else {\n\
set clbDecodeTimeoutTimes [expr $clbDecodeTimeoutTimes+1]\n\
}\n\
}\n\
\n\
Simulator instproc clb-parity-dueToFull-add { } {\n\
$self instvar clbParityDueToFullNumber\n\
if {![info exists clbParityDueToFullNumber]} {\n\
set clbParityDueToFullNumber 1\n\
} else {\n\
set clbParityDueToFullNumber [expr $clbParityDueToFullNumber+1]\n\
}\n\
}\n\
\n\
Simulator instproc total-packets-add { } {\n\
$self instvar totalPacketsGenerated\n\
if {![info exists totalPacketsGenerated]} {\n\
set totalPacketsGenerated 1\n\
} else {\n\
set totalPacketsGenerated [expr $totalPacketsGenerated+1]\n\
}\n\
}\n\
\n\
Simulator instproc attach-diffapp { node diffapp } {\n\
